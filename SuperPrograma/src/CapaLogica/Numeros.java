...
public class Numeros {
    public static String Factorial(String numero){
        ...
        try{
            ...
            return "Es factorial es de: "+acumulador;
        }catch(Exception e){
            return e.getMessage();
        }
    }
    ...
    public static void numeroRandom(){
        ...
        if(OtroValor==0.0)System.out.println("Su numero alatorio es"+ValorRedondeado);
        else System.out.println("Su numero aleatorio es: "+Valor);
    }
    public static String suma(String numero1, String numero2){
        try{
            return "Su suma es de: "+Double.parseDouble(numero1)+Double.parseDouble(numero2)+"";
        }catch(Exception e){
            return e.getMessage();
        }
    }
