...
public class Binario {
    public static String binarioDecimal(String numero){
        ...
        if(decimal==0.0)return "Su resultado en binario: "+Integer.toBinaryString(entero);
        return "Su resultado en binario: "+Integer.toBinaryString(entero)+postDecimal(decimal);
        }catch(Exception e){
            return e.getMessage();
        }
    }
